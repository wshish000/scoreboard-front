...
<!--                        </el-submenu>-->
                        ...
                        <el-submenu index="2"  popper-class="infoItem">
                            <template slot="title">
                                ...
                                <img :src="head" class='avatar' alt="">
                            </template>
                            <el-menu-item index="2-1" @click="setDialogInfo('pass')">{{ $t('commons.infoModify') }}</el-menu-item>
                            <el-menu-item index="2-2" @click="setDialogInfo('logout')">{{ $t('commons.quit') }}</el-menu-item>
                        </el-submenu>
                    </el-menu>
                </div>
            </div>
